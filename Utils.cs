...
namespace ChunkMergeTool
{
    internal static class Utils
    {
        ...
        {
            { 0xE0, 0xC8 }, { 0xE1, 0xC9 }, { 0xE2, 0xCA }, { 0xE3, 0xCB }, { 0xE4, 0xCC },
            { 0xE5, 0xCD }, { 0xE6, 0xCE }, { 0xE7, 0xCF }, { 0xE8, 0xD0 }, { 0xE9, 0xD1 },
            { 0xEA, 0xD2 }, { 0xEB, 0xD3 }, { 0xEC, 0xD4 }, { 0xED, 0xD5 },
            { 0xEF, 0xD4 },
        ...
        public static readonly List<byte> UseAct1CollisionForChunkIDs = [0x41, 0x42, 0X87];
        public static readonly List<byte> UseAct2CollisionForChunkIDs = [0x27, 0x4D, 0x4E, 0x4F, 0x64, 0xD1, 0xDF];

        public static readonly List<int> UseAct1CollisionForBlockIDs = [];
        public static readonly List<int> UseAct2CollisionForBlockIDs = [0x0DC, 0x0DD, 0x0E3, 0x0E4, 0x0ED, 0x0EE, 0x0EF, 0x0F0, 0x0F1, 0x0F2];
        public static readonly (int, int, int, int[]) PinnedBlocksAct2 = (0x1C1, 0x1E5, 0x26C, [0x1C5, 0x1C6, 0x1C7, 0x1C8, 0x1D5, 0x1D6, 0x1D7, 0x240]);
